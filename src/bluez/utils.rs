...
pub async fn register_object_with_path<T>(connection: &Connection, path: String, object: T) -> zbus::Result<()>
where
    T: Interface,
{
...
pub async fn find_adapter(connection: &Connection) -> Result<String, Error> {
